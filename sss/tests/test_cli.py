"""
Nav failu (split gadījumā kļūda/ziņojums)

Pilna split+combine plūsma ar īstu direktoriju, 5 daļām un atjaunošanu
"""

import sys
import os
# Ensure the project root is on PYTHONPATH so that `src` can be imported
